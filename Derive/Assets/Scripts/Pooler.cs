...
public class Pooler : MonoBehaviour
{
    ...
    [SerializeField] private List<PoolKey> poolkeys = new List<PoolKey>(); // permet de voir dict dans inspecteur
    ...
    private void AddInstance(Pool pool)
    {
        ...
        pool.queue.Enqueue(objectInstance); // add object to queue
    }
    ...
    IEnumerator RefreshPool(Pool pool)
    {
